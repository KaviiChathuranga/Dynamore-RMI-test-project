...
public class OrdersDto extends SuperDto implements Comparable<OrdersDto>{
    ...
    public OrdersDto(String oid,String date, int qty, String itemCode, String cid, String name, String address, String tel,String type,String startTime,String endTime,String chefName,String timeCount) {
        this.oid = oid;
        this.date = date;
        this.qty = qty;
        this.itemCode = itemCode;
